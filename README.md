...
VulkanScope is an Android Vulkan, Surface, Display and HDR inspection tool with local hardware collection, explicit opt-in Database submission and a user-controllable official GitHub update channel.
