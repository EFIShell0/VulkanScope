# legacy reference 4.12 parity audit

Baseline: legacy reference 4.12, Vulkan-Headers 1.4.357.

## Source parity

- legacy reference 4.12 extension feature/property handlers inspected: 304 extension names.
...
- legacy reference physical-device type tokens inspected: 395.
...
- Runtime-enumerated extensions are intersected with the 299 validated legacy reference 4.12 physical-device mappings and queried automatically.
