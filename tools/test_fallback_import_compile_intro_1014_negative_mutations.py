...
vm=__import__('re').search(r'versionName\s*=\s*"1\.0\.(\d+)"', gradle)
release_minor=int(vm.group(1)) if vm else 0
source_icon='R.drawable.ic_zip_download' if release_minor >= 17 else 'R.drawable.ic_action_github'
...
mutations=[
 ...
 ('stale version', lambda d: repl(d/'app/build.gradle.kts','versionCode = 1018','versionCode = 1013')),
