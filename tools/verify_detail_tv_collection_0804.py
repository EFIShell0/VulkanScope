...
dialog = body('ExpressiveDetailDialog')
need(dialog, 'shared expressive scrollable detail dialog missing')
need('verticalScroll(scrollState)' in dialog, 'detail dialog content is not vertically scrollable')
need('ExpressiveScrollHints(scrollState' in dialog, 'detail dialog scroll-boundary indicators missing')
