...
mutations = [
    ...
    ('restore Overview whole-card click', lambda d: replace_once(d / main_rel, 'onClick = { navigate(destination) },', 'onClick = { },')),
    ...
    ('uncontain watch add', lambda d: replace_once(d / main_rel, 'ExpressiveContainedIconTextButton("Add to watch list", R.drawable.ic_watch_add)', 'ExpressiveTextButton("Add to watch list")')),
    ('remove chain icon', lambda d: replace_once(d / main_rel, 'ExpressiveContainedIconTextButton("Copy link", R.drawable.ic_link)', 'ExpressiveContainedTextButton("Copy link")')),
