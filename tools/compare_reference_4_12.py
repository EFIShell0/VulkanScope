...
args=ap.parse_args()
cr=Path(args.reference_root); header=Path(args.header).read_text(encoding='utf-8', errors='ignore'); root=ET.parse(args.registry).getroot()
...
report={
  'reference':'legacy reference 4.12 local source checkout',
