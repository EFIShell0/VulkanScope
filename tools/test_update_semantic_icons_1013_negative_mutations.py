...
mutations = [
    ...
    ('remove Review chevron', lambda d: replace_once(d / main_rel, 'Icon(painterResource(R.drawable.ic_chevron_right), contentDescription = trademarkVulkanDisplayText(contentDescription)' if 'Icon(painterResource(R.drawable.ic_chevron_right), contentDescription = trademarkVulkanDisplayText(contentDescription)' in (d / main_rel).read_text(encoding='utf-8') else 'Icon(painterResource(R.drawable.ic_chevron_right), contentDescription = contentDescription', 'Icon(painterResource(R.drawable.ic_info), contentDescription = trademarkVulkanDisplayText(contentDescription)' if 'Icon(painterResource(R.drawable.ic_chevron_right), contentDescription = trademarkVulkanDisplayText(contentDescription)' in (d / main_rel).read_text(encoding='utf-8') else 'Icon(painterResource(R.drawable.ic_info), contentDescription = contentDescription')),
