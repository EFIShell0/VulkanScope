...
mutations = [
    ...
    ('make toggle row clickable', lambda d: replace_once(d / main_rel, 'Modifier.fillMaxWidth().padding(vertical = 4.dp)', 'Modifier.fillMaxWidth().toggleable(value = checked, role = Role.Switch, onValueChange = onCheckedChange).padding(vertical = 4.dp)')),
    ...
    ('remove external icon', lambda d: replace_once(d / main_rel, 'R.drawable.ic_open_external', 'R.drawable.ic_chevron_right')),
