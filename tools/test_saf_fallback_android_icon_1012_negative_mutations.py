...
('stale version',lambda d: rep(d/'app/build.gradle.kts', re.search(r'versionCode\s*=\s*\d+', (d/'app/build.gradle.kts').read_text(encoding='utf-8')).group(0), 'versionCode = 1011')),
]
