...
mutations = [
    ...
    ('Overview arrow returns muted', lambda d: replace_once(d / main_rel, 'contentDescription = "Open ${trademarkVulkanDisplayText(title)}", tint = VulkanAccentSoft, modifier = Modifier.size(20.dp)' if 'contentDescription = "Open ${trademarkVulkanDisplayText(title)}", tint = VulkanAccentSoft, modifier = Modifier.size(20.dp)' in (d / main_rel).read_text(encoding='utf-8') else 'contentDescription = "Open $title", tint = VulkanAccentSoft, modifier = Modifier.size(20.dp)', 'contentDescription = "Open ${trademarkVulkanDisplayText(title)}", tint = VulkanTextMuted, modifier = Modifier.size(20.dp)' if 'contentDescription = "Open ${trademarkVulkanDisplayText(title)}", tint = VulkanAccentSoft, modifier = Modifier.size(20.dp)' in (d / main_rel).read_text(encoding='utf-8') else 'contentDescription = "Open $title", tint = VulkanTextMuted, modifier = Modifier.size(20.dp)')),
