...
if not args.skip_version:
    ...
    need('schema 2 / technicalReport 3' in setup and 'vulkanscope-database-api.vulkanscope.workers.dev' in setup,'current Database schema/origin contract drifted')
if errors:
