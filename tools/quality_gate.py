...
if header_path:
    ...
    print('INFO canonical Vulkan header byte-level verification requires the locked 1.4.361 header; registry-level strict verification completed from the bundled vk.xml')
