...
need(('versionName = "0.41.45"' in g and 'versionCode = 455' in g) or ('versionName = "0.41.46"' in g and 'versionCode = 456' in g) or ('versionName = "0.80.0"' in g and 'versionCode = 800' in g) or ('versionName = "0.80.1"' in g and 'versionCode = 801' in g) or ('versionName = "0.80.2"' in g and 'versionCode = 802' in g) or ('versionName = "0.80.3"' in g and 'versionCode = 803' in g),'0.41.45+ compatible version metadata missing')
...
need(lock.get('vulkanBaseline')=='Vulkan 1.4.361','video registry Vulkan baseline mismatch')
...
need(lock.get('vulkanRegistrySha256')=='3ff4984b841932e04eebeb4ce2a6613ebd37c00ffb2e96549785b2c5d7da9e1d','video lock drifted from canonical Vulkan 1.4.361 registry')
